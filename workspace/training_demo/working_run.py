        ...
        with tf.gfile.GFile(PATH_TO_CKPT, 'rb') as fid:
            ...
            with detection_graph.as_default():
                with tf.Session(graph=detection_graph) as sess:
                        ...
                        if ret == True:
                            ...
                            for index, value in enumerate(output_dict['detection_classes']):
                                ...
                                if output_dict['detection_scores'][index] > threshold:
                                    ...
                                    print('NUMBER', (category_index.get(value)).get('name').count('bucket'))
                                ...
                                # with open('data_.csv', 'a+'):
                                #     for data in sorted_objects:
                                #         print('DAAAA', data)
                                #         print('dict', object_dict)
                                #         writer.writerow(data)
                            
                            # for key, value in itertools.groupby(sorted_objects, key=itemgetter('prediction')):
                            #     for i in value:
                            #         print('I', i)
                            #         with open('data_.csv', 'a+') as csvfile:
                            #             writer.writerow(i)
                            ...
                            # for model, group in itertools.groupby(objects, keyfunc):
                            # print(list(group))
                    ...
                    sorted_objects = sorted(objects, key=itemgetter('start')) 
                    print ('SORTD>', sorted_objects)
                    try:
